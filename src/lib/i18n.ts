...
export const translations = {
  he: {
    ...
    projectedDateHint:   'מחושב לפי ההפרש הקלורי היומי בין ה-TDEE שלך ליעד, בהנחה של 7,700 קק"ל לכל ק"ג שומן.',
  ...
  en: {
    ...
    projectedDateHint:       'Calculated based on the daily caloric difference between your TDEE and goal, assuming 7,700 kcal per kg of fat.',
  },
} as const
