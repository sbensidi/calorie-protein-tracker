...
## פאזה 0 — Polish מהיר (ניצחונות קלים, אין ארכיטקטורה)
...
## פאזה 1 — UX שוטף (נוגע כל יום, ROI גבוה)
...
### 2.4 · Weekly Goal Progress Card 🔵 `[C6]` ⏱ 4 שעות
...
### 4.3 · Push Notifications — תזכורת יומית 🔵 `[C7]` ⏱ 5 שעות
...
### 4.4 · Barcode History 🔵 `[C15]` ⏱ 3 שעות
